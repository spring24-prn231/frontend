        ...
        <nav className="navbar navbar-expand-lg navbar-dark fixed-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                <div className="navbar-nav mx-auto p-4 p-lg-0">
                    <Link to="index.html" className="nav-item nav-link active">Trang chủ</Link>
                    <Link to="/manager/feedback" className="nav-item nav-link">Về chúng tôi</Link>
                    <Link to="service.html" className="nav-item nav-link">Dịch vụ</Link>
                    <Link to="product.html" className="nav-item nav-link">Sản phẩm</Link>
